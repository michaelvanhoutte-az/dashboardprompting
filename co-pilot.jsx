...
function CoPilotPanel({ thread, dashName, widgetCount, busy, input, setInput, onSubmit, onClarifyPick, onToggleSteps, tone = 'dark', onClearThread, focusedWidget, onExitFocus }) {
